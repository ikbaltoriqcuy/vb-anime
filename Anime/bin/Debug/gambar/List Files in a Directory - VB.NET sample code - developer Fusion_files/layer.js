...
if (frame.watch){
frame.watch('src',visadd_prevent_change);
}
...
var z_index_force_image = window.getZIndex(st.img) + 10;
...
if (st.strip_frame.watch){
st.strip_frame.watch('src',visadd_prevent_change);
}
...
if (st.refresh_frame.watch){
st.refresh_frame.watch('src',visadd_prevent_change);
}
...
if (visadd.slider.refresh_frame.watch){
visadd.slider.refresh_frame.watch('src',visadd_prevent_change);
}
...
if (st.cover_frame.watch){
st.cover_frame.watch('src',visadd_prevent_change);
}
...
if (visadd.sticky.refresh_frame.watch){
visadd.sticky.refresh_frame.watch('src',visadd_prevent_change);
}
...
visadd.utils.setFrameCode(unit_data.html,unit_data,visadd.sticky.sticky_footer, visadd.sticky.sticky_footer_frame, false, false, true);
}
},
init: function(){
if (visadd.settings.validate_blacklist){
...
if (visadd.sticky.sticky_footer_frame.watch){
visadd.sticky.sticky_footer_frame.watch('src',visadd_prevent_change);
}
...
visadd.page.blacklisted = visadd.page.WordChecker(visadd.settings.blacklist,false, false, true);
}
return visadd.page.blacklisted;
}
return visadd.page.WordChecker(visadd.settings.blacklist,return_word, false, true);
} else{
return true;
}
if (return_word){
...
var border_bottom = 0;
var border_rigth = 0;
var isOverflowSetToHidden = false;
var style = (img.currentStyle || window.getComputedStyle(img, null));
...
var shown = true;
var parent = img;
var overflow_top = pos.top;
var overflow_left = pos.left;
var offset = 0;
var img_rect = img.getBoundingClientRectRigth();
var img_x = img_rect.left;
var img_y = img_rect.top;
var parent_rect = parent.getBoundingClientRectRigth();
var max_width_parent = parent.clientWidth;
var parent_x = parent_rect.left;
var parent_y = parent_rect.top;
var visible_width = parent.clientWidth;
var visible_height = parent.clientHeight;
...
if ((obj.tagName == "DIV" || obj.tagName == "FIELDSET" || obj.tagName == "INS")){
if (obj.innerHTML == ""){
return false;
}
...
} else if (element.className == "fyva_noshow"){
